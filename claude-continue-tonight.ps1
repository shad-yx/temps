# Claude One-Time Continue Agent - Tonight at 4 AM
# This will run once tonight and exit

$LogFile = "$PSScriptRoot\claude-continue-tonight.log"
$TargetHour = 4
$TargetMinute = 0
...
function Main {
    ...
    Log-Message "⏰ Waiting for 4:00 AM tonight..."
    Log-Message "=========================================="
    
    $CheckInterval = 10 # Check every 10 seconds for accuracy
    $Executed = $false
